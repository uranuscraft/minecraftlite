...
public class DivingStick extends Item {

	public DivingStick(int par1) {
		super(par1);
		 maxStackSize = 64;
	        setUnlocalizedName("divestick");
	}
 ...
 int i = movingobjectposition.blockX;
        ...
        if(entityplayer.capabilities.isCreativeMode||entityplayer.inventory.consumeInventoryItem(Item.redstone.itemID)) {
          if(entityplayer.isInWater()) {
        	entityplayer.setAir(1000);
          }
          if(entityplayer.isBurning()) {
        	  
        	 int h = potion.fireResistance.id;
        	  
        	  PotionEffect potioneffect = new PotionEffect(h,100);
